...
const Settings = () => {
  ...
  const signContractWithRestaurantIsEnabled = useAppSelector((state) => state.settings.signContractWithRestaurant.state);
  const signContractWithRestaurantId = useAppSelector((state) => state.settings.signContractWithRestaurant.restaurantId);
  return (
